...
export class RegisterComponent {
  ...
  constructor(public readonly appRoutesService: AppRoutesService, private _dataService: DataService, private _validationRules: ValidationService) {
  ...
  onSubmit(): void {
    ...
    if (this.registerUserForm.valid) {
      this._dataService.userRegister(this.registerUserForm.getRawValue());
